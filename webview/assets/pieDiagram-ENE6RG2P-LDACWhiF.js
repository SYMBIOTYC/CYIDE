import{n as e}from"./rolldown-runtime-DAXXjFlN.js";import{Pt as t}from"./src--5vrm9cX.js";import{n,r}from"./chunk-Y2CYZVJY-C9L_9xF4.js";import{m as i,p as a,t as o}from"./src-DVePe7UO.js";import{U as s,W as c,a as l,c as u,f as d,j as f,q as p,v as m,w as h,x as g,y as _}from"./chunk-WYO6CB5R-DdC8SWuk.js";import{Y as v,nt as y}from"./src-BgZN5txD.js";import{n as b,t as x}from"./chunk-VAUOI2AC-BUYTXF0a.js";import{n as S,t as C}from"./chunk-JWPE2WC7-Blh_Vn-A.js";import{n as w,r as T}from"./mermaid-parser.core-D3hkSUPv.js";import{d as E,i as D,m as O}from"./chunk-ICXQ74PX-BaEMtc7i.js";var k,A,j,M,N,P,F,I,L,R,z;e((()=>{C(),x(),E(),f(),a(),r(),w(),o(),k=d.pie,A={sections:new Map,showData:!1,config:k},j=A.sections,M=A.showData,N=structuredClone(k),P={getConfig:n(()=>structuredClone(N),`getConfig`),clear:n(()=>{j=new Map,M=A.showData,l()},`clear`),setDiagramTitle:p,getDiagramTitle:h,setAccTitle:c,getAccTitle:_,setAccDescription:s,getAccDescription:m,addSection:n(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);j.has(e)||(j.set(e,t),i.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:n(()=>j,`getSections`),setShowData:n(e=>{M=e},`setShowData`),getShowData:n(()=>M,`getShowData`)},F=n((e,t)=>{S(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),I={parse:n(async e=>{let t=await T(`pie`,e);i.debug(t),F(t,P)},`parse`)},L=n(e=>`
  .pieCircle{
...
//# sourceMappingURL=pieDiagram-ENE6RG2P-LDACWhiF.js.map